...
//////////////////////////////////////////////////////////////////////////
//
// Function:		CLabel::HorizonLine
//
// Description:		Sets the label looks like a Horizon Line
//
// INPUTS:          
// 
// RETURNS:         
...
// NT ALMOND				02072002    1.6     Origin
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::HorizonLine(COLORREF crBkgnd, int iWidth, int iHeight)
{
    SetWindowText(_T(""));
    SetBkColor(crBkgnd,crBkgnd,CLabel::Normal);
    CRect rect;
    GetWindowRect(rect);
    rect.SetRect(rect.left,rect.top,rect.left+iWidth,rect.top+iHeight);
    MoveWindow(rect);
    UpdateSurface();
...
CLabel& CLabel::VerticalLine(COLORREF crBkgnd, int iWidth, int iHeight)
{
    SetWindowText(_T(""));
    SetBkColor(crBkgnd,crBkgnd,CLabel::Normal);
    CRect rect;
