...
public:
    ...
    //add by hk
    virtual CLabel& HorizonLine(COLORREF crBkgnd = RGB(0,0,0), int iWidth = 5, int iHeight = 1);
    virtual CLabel& VerticalLine(COLORREF crBkgnd = RGB(0,0,0), int iWidth = 1, int iHeight = 5);
// Attributes
public:
protected:
	void UpdateSurface();
