...
public:
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Function Header
	CMyMemDC(CDC* pDC, CRect rect = CRect(0, 0, 0, 0)) : CDC(), m_oldBitmap(NULL), m_pDC(pDC)
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
...
public:
	...
	void DisplayCurrentTime( CString strFormat = _T("%H:%M:%S") );
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Function Header
	void Display(UINT uSecs=0, UINT uMins=0, UINT uHours=0, UINT uDays=0, CString strFormat = _T("%D:%H:%M:%S") )
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
...
protected:
	void Update();
	void Draw(CMyMemDC* pDC, DWORD dwChar, int nCol);
